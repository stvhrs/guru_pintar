...
class HalamanRandom extends StatefulWidget {
  

  @override
  State<HalamanRandom> createState() => _HalamanRandomState();
}

class _HalamanRandomState extends State<HalamanRandom> {
  ...
  Widget build(BuildContext context) {
    ...
    Map<dynamic, dynamic> randomQuestionsMap =
        getRandomQuestionsAndOptions(widgetQuestionsList, widgetQuestionsList.length);
